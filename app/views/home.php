<main id="home-page">
            ...
            <div class="swiper interval-small">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_1.jpg" ?>" alt="Gallery image">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_2.jpg" ?>" alt="Gallery image">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_3.jpg" ?>" alt="Gallery image">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_4.jpg" ?>" alt="Gallery image">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_5.jpg" ?>" alt="Gallery image">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_6.jpg" ?>" alt="Gallery image">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_7.jpg" ?>" alt="Gallery image">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_8.jpg" ?>" alt="Gallery image">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= BASE_URL . "app/public/images/gallery_9.jpg" ?>" alt="Gallery image">
                    </div>
                </div>
    ...
    <section class="localization-section">
        <div class="container">
            <h2 class="delay-small text-detail--secondary">Localização</h2>
